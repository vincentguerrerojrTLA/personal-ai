...
class MainActivity:AppCompatActivity(){
 ...
 override fun onCreate(s:Bundle?){super.onCreate(s);setContentView(R.layout.activity_main)
  ...
  findViewById<Button>(R.id.libraryButton).setOnClickListener{append("Kylow","Kylow Library is ready for approved local files. Connected storage stays separate until you approve an integration.")}
